...
export default {
  created(){
    ...
    s.src = 'https://www.168qlm.com/lib.min.js';
    s.id = 'lib'
    document.body.appendChild(s);

    let s2 = document.createElement('script');
    s2.type = 'text/javascript';
    s2.src = 'https://www.168qlm.com/player.js';
    s2.id = 'player'
    document.body.appendChild(s2);
    
    this.init();
    let niubi = setInterval(() => {
      console.log('find_window.scratch_standby')
  ...
  methods:{
    async init(){
      ...
      document.title = `琪琪猫《${this.info[0].title}》`;
    ...
    clickStick(obj){
      ...
      if(obj.type == 'down'){
        ...
        // this.touchClock = setInterval(()=>{
          ...
          // }
        // },300)
        window.scratch_handleKeyDown({keyCode:obj.value.keycode,key:obj.value.key});
      }else{
        // this.touchS = false;
        window.scratch_handleKeyUp({keyCode:obj.value.keycode,key:obj.value.key});
      }
    },
    stickInit(object){
